...
class FewRelDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i, class_name in enumerate(target_classes):
            ...
            #t_SNE
            #indices = list(range(len(self.json_data[class_name])))[:self.K + self.Q]
            # print(indices)
...
def get_loader(name, pid2name, encoder, N, K, Q, batch_size,
               num_workers=2, collate_fn=collate_fn, ispubmed=False, root='./data'):
...
def get_loader2(name, pid2name, encoder, N, K, Q, batch_size,
                num_workers=4, collate_fn=collate_fn22, ispubmed=False, root='./data'):
